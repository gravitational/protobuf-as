...
export class Elementaries {
  ...
  public size(): u32 {
    ...
    size += this.SInt32 == 0 ? 0 : 1 + __proto.Sizer.sint32(this.SInt32);
    size += this.Fixed32 == 0 ? 0 : 1 + 4;
    size += this.SFixed32 == 0 ? 0 : 1 + 4;
    size += this.Int64 == 0 ? 0 : 1 + __proto.Sizer.int64(this.Int64);
    size += this.UInt64 == 0 ? 0 : 1 + __proto.Sizer.uint64(this.UInt64);
    size += this.SInt64 == 0 ? 0 : 1 + __proto.Sizer.sint64(this.SInt64);
    ...
    size +=
      this.String.length > 0
        ? 2 + __proto.Sizer.varint64(this.String.length) + this.String.length
        : 0;
    size +=
    ...
    size +=
      this.EmptyString.length > 0
        ...
        : 0;
    size += this.EmptyInt64 == 0 ? 0 : 2 + __proto.Sizer.int64(this.EmptyInt64);
    size += this.EmptyInt32 == 0 ? 0 : 2 + __proto.Sizer.int64(this.EmptyInt32);
  ...
  encodeU8Array(
    ...
    if (this.SFixed64 != 0) {
      encoder.uint32(0x61);
      encoder.sfixed64(this.SFixed64);
    }
    if (this.Bool != 0) {
      encoder.uint32(0x68);
